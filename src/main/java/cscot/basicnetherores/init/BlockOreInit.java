...
public class BlockOreInit {
	...
	public static final Block ORE_NETHERLEAD = new BlockOreBase("ore_netherlead", "Lead");
	public static final Block ORE_NETHERURANIUM = new BlockOreBase("ore_netheruranium", "Uranium");
}
